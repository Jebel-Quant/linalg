...
from ..core.exceptions import DEFAULT_COND_THRESHOLD, NonSquareMatrixError
from ..core.exceptions import check_and_warn_condition as _check_and_warn_condition
