...
from ..core.exceptions import NegativeWarmupError as NegativeWarmupError
from ..core.exceptions import NonIntegerWarmupError
...
try:
    ...
    _msg = (
        "polars is required for cvx.linalg.covariance.ewm_cov; "
